...
while (VOT)
{
    ...
    ELE[VOT-1]++; /* Los votos se almacenan en el arreglo. Recuerda que la primera posici�n del arreglo es 0, por esa raz�n a la variable VOT se le descuenta 1. Los votos del primer candidato se almacenan en la posici�n 0. */
    else
