...
void main(void)
{
    ...
    cad0 = malloc(strlen(cad0) + strlen(cad3) + 1); // Asignar memoria dinámica
    strcpy(cad0, "Hola México"); // Restablecer el valor original de cad0
    strcat(cad0, cad3);
    ...
    free(cad0); // Liberar la memoria asignada dinámicamente
}
