...
/* La funci�n Imprime se utiliza para escribir un arreglo unidimensional, sin repeticiones, de T elementos de tipo entero. */
{
int I;
for (I=0; I<T; I++)
printf("\nA[%d]: %d", I, A[I]);
...
/* Esta funci�n se utiliza para eliminar los elementos repetidos de un arreglo unidimensional de T elementos de tipo entero. */
{
int I = 0, K, L;
while (I < (*T-1))
{
